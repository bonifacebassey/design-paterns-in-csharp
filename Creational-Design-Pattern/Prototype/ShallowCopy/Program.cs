...
/* After creating the second object and change the location, it also changed the location of the first object. This is because:
 * 1. MemberwiseClone only copies the non-static fields of one object to a new object
 * 2. Value types are copied bit by bit which is Ok
 * 3. For reference types, the reference is copied but the referenced object not.
 */